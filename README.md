...
Learning is a lifelong process, and I'm always eager to learning new technologies and continuously expanding my skill set to stay ahead of the curve of the ever-evolving world of technology.
...
<p>
  ...
  <a target="_blank" href="Flask-Dark.svg"><img src="Flask-Dark.svg" alt="Flask" width="42" height="42" /></a>
  <a target="_blank" href="TensorFlow-Dark.svg"><img src="TensorFlow-Dark.svg" alt="HTML5" width="42" height="42" /></a>
  <a target="_blank" href="VSCode-Dark.svg"><img src="VSCode-Dark.svg" alt="HTML5" width="42" height="42" /></a>
  <a target="_blank" href="Python-Dark.svg"><img src="Python-Dark.svg" alt="HTML5" width="42" height="42" /></a>
...
<h2>🌱 About Me</h2>
<ul>
  <li>Exploring the world of AI , Web Development and App Development.</li>
  <li>Studied C and C++, Python and C# programming languages.</li>
  <li>Working in AI and Website Development.</li>
  <li>Studied Full-Stack Development: HTML, CSS, JavaScript (Front-End) and Flask, Python (Back-End) , AI tensorflow keras and PyTorch.</li>
  <li>Keenly interested in Modern AI and Machine Learning.</li>
  <li>📫 Reach me via email: <a href="mailto:reemyabdelghfar@gmail.com">reemyabdelghfar@gmail.com</a></li>
</ul>
